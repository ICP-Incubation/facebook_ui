  ...
  return (
    <div className="py-2 px-4 bg-white shadow-md flex justify-between items-center top-0 sticky z-50">
      ...
      <div className="flex items-center gap-4 ">
        <div className="icon_wrapper text-[28px] bg-gray-200 rounded-full p-2 cursor-pointer">
          <CgMenuGridO />
        </div>

        <div className="icon_wrapper text-[20px] bg-gray-200 rounded-full p-3 cursor-pointer">
          <BsMessenger />
        </div>
